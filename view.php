...
$id = intval($_GET['id']);
$mirror_al = mysql_query("SELECT id,hacker,url,type,description FROM ".$tablo." WHERE id = '$id' limit 1");
$mirror = mysql_fetch_array($mirror_al);
$kontrol = $mirror[0];
if($kontrol == 0){
if ($tablo == "eski"){
echo "<br /><center>xD<br /></center><br />";
}else{
echo "<br /><center>Ahhh,,, you re gone everything nigga....<br /><a href='../'>Back</a></center><br />";
}
} else {
...
<li><a href="/">Home</a></li>
<li><a href="highlight/">Purchase a Highlighted Spot</a></li>
<li><a href="user/">Users</a></li>
<li><a href="owner/">Server Owners</a></li>
...
<div class="container">
<div class="row">
<h2>Servers Statistics</h2>
<div class="col-sm-9 col-md-9">
<div class="col-sm-12 col-md-12 game-detail">
<h1><? echo strip_tags($mirror["hacker"]); ?></h1>
<div class="col-sm-12 col-md-12 topnote">
<div class="col-sm-4 col-md-3">
<img src="uploads/logo/server_default.png" alt="" class="img-responsive"></div>
<div class="col-sm-8 col-md-9 vote">
            <a data-toggle="modal" data-target="#modalVote" id="voteLink" href="#" data-id="Clash of Lights | COC | 8.332.16*180"><img src="images/vote.png" alt="" class="img-responsive">VOTE</a>
            &nbsp;<a href="javascript:void(0);" onclick="return subscribe_news('180');"><img src="images/subscribe.png" alt="" class="img-responsive">SUBSCRIBE</a>
</div>
</div>
<!-- Nav tabs -->
...
<li role="presentation"><a href="" aria-controls="" role="tab" data-toggle="tab">Banner</a></li>
...
<td width="25%"><? echo strip_tags($mirror["type"]); ?></td>
</tr>
<tr>
<td>Status</td>
<td><font color="#006600">Online</font></td>
<td>Uptime</td>
<td>
67.73%</td>
</tr>
...
Website</td>
<td class="web">
<a href="<? echo strip_tags($mirror["url"]); ?>" target="_blank"><? echo strip_tags($mirror["url"]); ?></a>
</td>
<td>
Server Rank
</td>
<td>
<? echo strip_tags($mirror["id"]); ?></td>
</tr>
<tr>
<td></td>
<td></td>
<td>Download</td>
<td>
<a href="<? echo strip_tags($mirror["url"]); ?>" target="_blank">APK</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="<? echo strip_tags($mirror["url"]); ?>" target="_blank">IPA</a>
</td>
</tr>
</table>
</div>
...
<p align="center">No news added!</p>
</div>
...
<tr>
<td align="center">
<img id="draw_image"  class="img-responsive"/>
</td>
</tr>
<tr>
<td align="center">
<strong>Banner Dimensions</strong><br/>
<select class="form-control" name="banner_dimension" id="banner_dimension">
	<option value="728x90|Clash_of_Lights__COC__833216|">728x90</option>
	<option value="336x280|Clash_of_Lights__COC__833216|">336x280</option>
    <option value="320x100|Clash_of_Lights__COC__833216|">320x100</option>
    <option value="300x600|Clash_of_Lights__COC__833216|">300x600</option>
    <option value="300x250|Clash_of_Lights__COC__833216|">300x250</option>
</select>
</td>
</tr>
<tr>
<td style="padding-left:40%;">
<strong>Show on banner</strong><br/>
<ul>
	<li>Server Name: <input type="checkbox" name="b_name" id="b_name" value="N" checked="checked"/></li>
    <li>Motto: <input type="checkbox" name="b_motto" id="b_motto" value="M" checked="checked"/></li>
    <li>Status: <input type="checkbox" name="b_status" id="b_status" value="S" checked="checked"/></li>
    <li>Show Rank No: <input type="checkbox" name="b_rank" id="b_rank" value="R" checked="checked"/></li>
    <li>Uptime: <input type="checkbox" name="b_uptime" id="b_uptime" value="U" checked="checked"/></li>
</ul>
</td>
</tr>
<tr>
...
<input type="text" class="form-control" id="html_code" value="<a href=&quot;http://ucslist.com/Clash_of_Lights__COC__833216&quot; target=&quot;_blank&quot;><img src=&quot;http://ucslist.com/draw/image.php?param=Q2xhc2hfb2ZfTGlnaHRzX19DT0NfXzgzMzIxNg==&amp;show=Kk4qTSpTKlIqVQ==&amp;w=728&amp;h=90&quot; /></a>"/>
</td>
</tr>
<tr>
<td align="center">
<strong>BB Code</strong><br/>
<input type="text" class="form-control" id="bb_code" value="[url=http://ucslist.com/Clash_of_Lights__COC__833216][img]http://ucslist.com/draw/image.php?param=Q2xhc2hfb2ZfTGlnaHRzX19DT0NfXzgzMzIxNg==&amp;show=Kk4qTSpTKlIqVQ==&amp;w=728&amp;h=90[/img][/url]"/>
</td>
</tr>
<!--<tr>
<td>
<h4>HTML Code</h4>
<textarea class="input-sm" style="width:100%;"><a href='#'><img src='images/clash-of-clans-banner.jpg' class='img-responsive' /></a></textarea>
</td>
</tr>-->
<!--<tr>
<td>
<h4>BB Code</h4>
<textarea class="input-sm" style="width:100%;" >[url=http://www.ucslist.com/]This ucslist.com[/url]</textarea></td>
</tr>-->
</table>
</div>
</div>
...
<script>
    ...
    var disqus_config = function () {
        this.page.url = 'http://ucslist.com/Clash_of_Lights__COC__833216';  // Replace PAGE_URL with your page's canonical URL variable
        this.page.identifier = 'Clash_of_Lights__COC__833216'; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
    };
    (function() {  // DON'T EDIT BELOW THIS LINE
        var d = document, s = d.createElement('script');
        s.src = 'http://ucserverlist.disqus.com/embed.js';
...
<div class="col-sm-12 col-md-12 game-descript">
<h3>Description</h3>
<div class="col-sm-12 col-md-12" style="word-wrap:break-word;">
<p><? echo strip_tags($mirror["description"]); ?></p></div>
</div>
</div>
...
window.onload=function(){ new DaysHMSCounter('September 30, 2016 23:59:59', 'counter'); }
</script>
</head>
<div class="container">
<div class="row">
