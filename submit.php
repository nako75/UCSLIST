...
<div class="col-sm-9 col-md-9">
 ...
 <form action="kontrol.php" method="POST" class="form-horizontal">   
                     <input type="hidden" name="id" value=""/>
                        <div class="form-group">
                            <div class="alert alert-dismissible alert-danger" id="err_password" style="display:none;">
                                <button type="button" class="close" data-dismiss="alert"><i class="fa fa-close"></i></button>
                                Passwords does not match!
                            </div>
                            <div class="alert alert-dismissible alert-danger" id="err_captcha" style="display:none;">
                                <button type="button" class="close" data-dismiss="alert"><i class="fa fa-close"></i></button>
                                Captcha is not validated!
                            </div>
							                            <label class="col-sm-3 control-label">Server Name</label>
                            <div class="col-sm-7">
                                <input name="hacker" id="hacker" type="text" class="form-control" required="required" value="" title="Only Alphabets Allowed!"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                            <input name="type" id="type" type="text" class="form-control" required="required" value="" pattern="[A-Za-z\s]+" />
                            </div>
                        </div>
                        <div class="hr-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input name="site" id="site" type="text" class="form-control" required="required" value="" pattern="[A-Za-z\s]+" />
                            </div>
                            <div class="col-sm-2" id="username_check">&nbsp;</div>
                        </div>
                        <div class="hr-dashed"></div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Description</label>
                            <div class="col-sm-7">
                                <input name="description" id="description" type="text" class="form-control" required="required" value="" pattern="[A-Za-z\s]+" />
                            </div>
                        </div>
                        <div class="hr-dashed"></div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Qoute / Little Description</label>
                            <div class="col-sm-7">
                                <input name="note" id="note" type="text" class="form-control" required="required" value="" pattern="[A-Za-z\s]+" />
                            </div>
                        </div>
                       	<div class="hr-dashed"></div>
                        <div class="form-group">
                        <div class="col-sm-8 col-sm-offset-3">
                        	<div class="g-recaptcha" data-sitekey="6LeKAwETAAAAAJR4G1KYBXhh6cEKHs1sfTB2Oe7o"></div>
                        </div>
                        </div>
                        <div class="hr-dashed"></div>
                        <div class="form-group">
                            <div class="col-sm-8 col-sm-offset-3">
                            <input type="hidden" name="gkodumuz" value="123456"><input type="hidden" name="zgkod" value="123456"><input type="hidden" name="sunucu" value="<? echo getenv('REMOTE_ADDR'); ?>">
                            
                                <input type="reset" name="Cancel" value="Reset" class="btn btn-default">                               
                                <input type="submit" value="Submit" class="btn-btn-primary" style="font-size: 10pt;" onclick="javascript:this.form.submit();this.disabled=true;this.value='Sending...';">                          
                            </div>
                        </div>
                    </form>
                </div>
